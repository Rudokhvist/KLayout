...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ PSTR szCmdLine, _In_ int iCmdShow) {
	...
	BOOL processIs64bit;
	is64bit = DoesWin32MethodExist(L"kernel32.dll", "IsWow64Process") ? IsWow64Process(GetCurrentProcess(), &processIs64bit) ? processIs64bit : FALSE : FALSE;
	...
	MenuItem->dwTypeData = L"Language preferences";
...

{
	...
	GetLocaleInfo(
		MAKELCID((UINT)Lang & 0xffffffff, SORT_DEFAULT),
